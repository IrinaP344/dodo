    ...
    <div class="col-10 mx-auto">     
        <div class="row">   <!-- header -->
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
             <?php 
                $query2 = mysqli_query($con, "SELECT * FROM trash");
                ...
                <div class="row">
                    ...
                    <div class="col-2 mt-2">
                        <form action="delete.php" method="GET">
                            <input style="display: none;" value='<?php echo $stroka1["id"] ?>' name="id" class="form-control">
            ...
            <?php } } ?>
                <?php 
                    $query3 = mysqli_query($con, "SELECT SUM(price) AS summa FROM trash");
                    $result = $query3->fetch_assoc();
                 ?>
                <h2>Сумма: <?php echo $result['summa'] ?></h2>
                <form action="delete2.php" method="GET">
                    <button class="btn bg-btn-dodo cls my-3">Удалить всё</button>
                </form>
        ...
        <?php 
         ...
         ?>
            <div class="col-3">   
                ...
                <input type="" name="img" style="display: none;" value='<?php echo $stroka["img"]?>' >
                <div class="pizz"> 
                    <h3><?php echo $stroka['title'] ?><input type="" name="title" style="display: none;" value='<?php echo $stroka["title"]?>' ></h3>   
                    <p class="text-secondary"><?php echo $stroka['description'] ?></p>
                </div>  
                <div class="row">
                    <div class="col-6">
                        <h3> <?php echo $stroka['price'] ?><input type="" name="price" style="display: none;" value='<?php echo $stroka["price"]?>' ><span>₽</span></h3>                        
                    </div>
                    <div class="col-6">
